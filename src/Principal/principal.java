...
public class principal {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * op.adicionarPessoa("Nome 1", 20, 1.66); op.adicionarPessoa("Nome 2", 24,
		 * 1.44); op.adicionarPessoa("Nome 3", 30, 1.89); op.adicionarPessoa("Nome 4",
		 * 51, 1.56);
		 * 
		 ...
		 * 
		 * cc.removerConvidadoPorCodigoConvite(5588); cc.exibirConvidados();
		 * 
		 * System.out.println("Existem " + cc.contarConvidados() +
		 * " convidados dentro do Set de Convidados");
		 * 
		 ...
		 * 
		 * ac.adicionaContato("Gil", 123456); ac.adicionaContato("Gil", 99563);
		 * ac.adicionaContato("Gil Moura", 111111); ac.adicionaContato("José_Silva",
		 * 123456);
		 * 
		 ...
		 * ac.exibirContatos();
		 * 
		 * // Testando agenda de contatos Map AgendaContatosMap acm = new
		 * AgendaContatosMap();
		 * 
		 * acm.adicionaContatosMap("Gil", 44455); acm.adicionaContatosMap("Gil Moura",
		 * 11455); acm.adicionaContatosMap("Gil", 11111);
		 ...
		 * 
		 * cp.adicionaProdutos("Produto 1", 1, 15d, 5); cp.adicionaProdutos("Produto 2",
		 * 2, 10d, 5); cp.adicionaProdutos("Produto 3", 3, 8d, 5);
		 ...
		 * estoque.calculaValorTotalEstoque()); System.out.println("Produto mais caro: "
		 * + estoque.retornaProdutoMaisCaro());
		 * 
		 * 
		 * 
		 * CarrinhoDeCompras carrinho = new CarrinhoDeCompras();
		 * 
		 * carrinho.adicionarItem("Item 1", 50.0, 5); carrinho.adicionarItem("Item 2",
		 * 75.0, 15); carrinho.adicionarItem("Item 3", 25.0, 10);
		 * 
